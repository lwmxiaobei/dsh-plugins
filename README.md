...
更新时间：2026-08-14T03:30:13.913Z

当前收录 529 个通过基础 bundle 清单校验的插件。插件地址和介绍均来自对应的上游仓库。
...
| [cendaifeng/dsh-learn-everything](https://github.com/cendaifeng/dsh-learn-everything) | 上游仓库暂未提供介绍 | `dsh-learn-everything` | NOASSERTION | 3 |
...
| [detpecca/dsh-llm-wiki](https://github.com/detpecca/dsh-llm-wiki) | 上游仓库暂未提供介绍 | `@detpecca/dsh-llm-wiki` | MIT | 3 |
...
| [omdsh-dev/dsh-hub](https://github.com/omdsh-dev/dsh-hub) | 上游仓库暂未提供介绍 | `@omdsh/dsh-hub` | MIT | 3 |
...
| [xingyingyuzhui/dsh-updater-ui](https://github.com/xingyingyuzhui/dsh-updater-ui) | 上游仓库暂未提供介绍 | `dsh-updater-ui` | MIT | 3 |
...
| [omdsh-dev/dsh-daily-progress](https://github.com/omdsh-dev/dsh-daily-progress) | 上游仓库暂未提供介绍 | `dsh-daily-progress` | BSD-3-Clause | 2 |
| [omdsh-dev/dsh-ernie-image](https://github.com/omdsh-dev/dsh-ernie-image) | 上游仓库暂未提供介绍 | `dsh-ernie-image` | BSD-3-Clause | 2 |
...
| [omdsh-dev/dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 上游仓库暂未提供介绍 | `dsh-lark-channel` | BSD-3-Clause | 2 |
| [omdsh-dev/dsh-longbridge](https://github.com/omdsh-dev/dsh-longbridge) | 上游仓库暂未提供介绍 | `dsh-longbridge` | BSD-3-Clause | 2 |
| [omdsh-dev/dsh-paddle-ocr](https://github.com/omdsh-dev/dsh-paddle-ocr) | 上游仓库暂未提供介绍 | `dsh-paddle-ocr` | BSD-3-Clause | 2 |
...
| [omdsh-dev/dsh-voice-funasr](https://github.com/omdsh-dev/dsh-voice-funasr) | 上游仓库暂未提供介绍 | `dsh-voice-funasr` | MIT | 2 |
...
| [Ayase34/gal-view](https://github.com/Ayase34/gal-view) | 上游仓库暂未提供介绍 | `gal-view` | MIT | 1 |
...
| [zhang66633/dsh-plugin-installer](https://github.com/zhang66633/dsh-plugin-installer) | 上游仓库暂未提供介绍 | `dsh-plugin-installer` | MIT | 1 |
...
| [biociao/dsh-science](https://github.com/biociao/dsh-science) | 上游仓库暂未提供介绍 | `dsh-science` | MIT | 0 |
...
| [EvilIrving/dsh-context-proxy](https://github.com/EvilIrving/dsh-context-proxy) | 上游仓库暂未提供介绍 | `dsh-context-proxy` | MIT | 0 |
| [EvilIrving/dsh-proof](https://github.com/EvilIrving/dsh-proof) | 上游仓库暂未提供介绍 | `dsh-proof` | MIT | 0 |
| [EvilIrving/dsh-repro](https://github.com/EvilIrving/dsh-repro) | 上游仓库暂未提供介绍 | `dsh-repro` | MIT | 0 |
...
| [fishlikewater/dsh-mcp-manager](https://github.com/fishlikewater/dsh-mcp-manager) | 上游仓库暂未提供介绍 | `dsh-mcp-manager` | MIT | 0 |
...
| [hccccc01333/dsh-analytics](https://github.com/hccccc01333/dsh-analytics) | 上游仓库暂未提供介绍 | `dsh-analytics` | MIT | 0 |
...
| [inmny/dsh-git-bash](https://github.com/inmny/dsh-git-bash) | 上游仓库暂未提供介绍 | `dsh-plugin-git-bash` | MIT | 0 |
...
| [LaoYueHanNi/dsh-token-usage](https://github.com/LaoYueHanNi/dsh-token-usage) | 上游仓库暂未提供介绍 | `dsh-token-usage` | NOASSERTION | 0 |
...
| [leechen298/Code2Skill](https://github.com/leechen298/Code2Skill) | 上游仓库暂未提供介绍 | `@leechen298/code2skill` | Apache-2.0 | 0 |
...
| [lordship12138-crypto/dsh-plugin-dedup](https://github.com/lordship12138-crypto/dsh-plugin-dedup) | 上游仓库暂未提供介绍 | `dsh-plugin-dedup` | NOASSERTION | 0 |
...
| [MAXeaglet/dsh-bash-terminal](https://github.com/MAXeaglet/dsh-bash-terminal) | 上游仓库暂未提供介绍 | `dsh-bash-terminal` | MIT | 0 |
...
| [peach0x33a/dsh-open-browser](https://github.com/peach0x33a/dsh-open-browser) | 上游仓库暂未提供介绍 | `dsh-open-browser` | MIT | 0 |
...
| [radaren/dsh-auth](https://github.com/radaren/dsh-auth) | 上游仓库暂未提供介绍 | `dsh-auth` | MIT | 0 |
...
| [tkr520521/dsh-team-runner](https://github.com/tkr520521/dsh-team-runner) | 上游仓库暂未提供介绍 | `dsh-team-runner` | MIT | 0 |
...
| [vvlife/dsh-agnes-paseo](https://github.com/vvlife/dsh-agnes-paseo) | 上游仓库暂未提供介绍 | `dsh-agnes-paseo` | MIT | 0 |
...
| [yweilai77-dev/dsh-plugin-cost](https://github.com/yweilai77-dev/dsh-plugin-cost) | 上游仓库暂未提供介绍 | `dsh-plugin-cost` | NOASSERTION | 0 |
