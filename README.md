...
更新时间：2026-08-14T02:18:56.319Z

当前收录 475 个通过基础 bundle 清单校验的插件。插件地址和介绍均来自对应的上游仓库。
...
| [omdsh-dev/dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 上游仓库暂未提供介绍 | `dsh-lark-channel` | BSD-3-Clause | 1 |
